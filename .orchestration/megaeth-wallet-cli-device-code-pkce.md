...
- [x] task-1: Add PKCE and device auth helpers
- [x] task-2: Wire device auth into wallet commands

### Epic 2: Wallet Backend Device Broker

- [x] task-3: Add backend device auth persistence
- [x] task-4: Add backend device auth routes

### Epic 3: Wallet UI Device Authorization

- [x] task-5: Add device auth lookup and code-entry screen
- [x] task-6: Reuse grant and revoke approval flows

### Epic 4: Local E2E And Documentation

- [x] task-7: Extend local shim and E2E harness
- [x] task-8: Update user and agent documentation
